        ...
        <div className="navbar-start align-items-center">
          <div className="hidden sm:inline w-22 h-22 md:p-2 ml-10">
            <Link href="https://solana.com" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
              {/* Replace the existing SVG code with your new logo */}
              <img src="https://media.discordapp.net/attachments/804328230378012703/1157246994365030490/image.png?ex=6517e9c0&is=65169840&hm=1f0209066420ef3e124d2882795e642a2192bd6b4890d4e2d1a899e25a31ddb3&=&width=192&height=87" alt="Your Logo" className="h-22   w-22 md:p-2 ml-10" />
            </Link>
          </div>
